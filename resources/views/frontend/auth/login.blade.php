    ...
    <div class="card-body login-card-body">
      ...
      <div class="social-auth-links text-center mb-3">
        ...
        <a href="#" class="btn btn-block btn-danger">
          <i class="fas fa-google-plus mr-2"></i> Sign in using Google+
        </a>
      </div>
      <!-- /.social-auth-links -->
      ...
      <p class="mb-1">
        @if (Route::has('password.request'))
            <a class="btn btn-link" href="{{ route('password.request') }}">{{ __('I forgot my password?') }}
            </a>
        @endif
      </p>
      <p class="mb-0">
        <a href="{{ route('register') }}" class="text-center">{{ __('If your are new then you can register in Eshop') }}</a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>
