                            ...
                            <thead>
                                ...
                                @foreach ($categories as $category )
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                             @if($category->status == 1)
                                            <a class="btn btn-danger" href="{{ route('admin.category.deactivecategory',$category->id) }}">
                                                <i class="fas fa-thumbs-down"></i>
                                            </a>
                                            @else
                                            <a class="btn btn-success" href="{{Route('admin.category.activecategory',$category->id)}}">
