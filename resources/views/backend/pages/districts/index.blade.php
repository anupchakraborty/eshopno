                            ...
                            <thead>
                                ...
                                @foreach ($districts as $district )
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-warning" href="{{ route('admin.district.edit', $district->id)}}">
                                            ...
                                            <a  href="#deleteModal{{ $district->id }}" class="btn btn-danger" data-toggle="modal">
                                             ...
                                             <!--Delete Modal -->
                                            <div id="deleteModal{{ $district->id }}" class="modal fade">
